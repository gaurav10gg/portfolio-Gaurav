      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl lg:text-5xl font-bold mb-4">
            Let&apos;s <span className="text-green-400">Build</span>
          </h2>
          <p className="text-white/60 text-lg mb-8 max-w-lg mx-auto">
            If you are looking for a developer who cares about clean systems, sharp
            execution, and thoughtful product work, let&apos;s talk.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="group relative inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-green-500 to-emerald-400 rounded-lg text-white font-semibold overflow-hidden btn-shine"
            >
          ...
          <motion.a
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="inline-flex items-center gap-2 mt-6 px-6 py-3 border border-green-400 text-green-400 rounded-full hover:bg-green-400 hover:text-dark-900 transition-all duration-300"
          >
        ...
        >
          Copyright {new Date().getFullYear()} gaurav G. All rights reserved.
        </motion.p>
      </div>
    </footer>
  );
